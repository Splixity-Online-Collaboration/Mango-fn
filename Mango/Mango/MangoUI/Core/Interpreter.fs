    ...
    List.fold
        (fun (accElements, accTab) element ->
            ...
            | Row(props, elements, pos) ->
                ...
                | None -> accElements @ [ Row(props, subElements, pos) ], tab'
            | Column(props, elements, pos) ->
                ...
                | Some id ->
                    ...
                    accElements @ [ Identifier(id, pos) ], tab''
                | None -> accElements @ [ Column(props, subElements, pos) ], tab'
            | _ -> accElements @ [ element ], accTab)
        ([], tab)
        elements
